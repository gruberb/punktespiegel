...
Classic-v1 bleibt das deterministische Vergleichsmodell. Classic-v2 übernimmt dessen validierte Punkteprognose als Champion, ergänzt die neue Rollenprognose und bewertet die eine positionsgebundene Reserve exakt dann, wenn mindestens ein Starter der Position ausfällt. Das zweistufige HiGHS-Modell bestimmt den 15er-Septemberkader, feste 4-4-2-Starter und Reserven sowie einen regelkonformen Winterkader mit höchstens drei positionsgleichen Wechseln. Realisierte Holdout-Punkte verwenden die exakte automatische Reserveaktivierung.

Interactive-v2 nutzt die vollständigen Spieler-Spiel-Daten. Ein chronologisch trainierter CatBoost-Klassifikator schätzt DNP, Einwechslung und Startelf; nach Position und Rolle getrennte Regressoren schätzen bedingten Mittelwert sowie P10, Median und P90. Spieler mit wenig Historie werden zu einem aus Position, Liga und Preisstufe gelernten empirischen Prior zurückgezogen. Das nachgelagerte HiGHS-Modell besitzt einen September- und einen Winterkader, höchstens drei positionsgleiche Winterwechsel sowie eigene Aufstellungs- und Formationsentscheide für jeden Spieltag. Seine Hauptzielfunktion ist die Summe der erwarteten Punkte der jeweils besten gültigen Elf, nicht eine feste Startelf mit pauschalem Bankabschlag.

Vor dem finalen Training wird das Mischgewicht auf einer früheren Vorsaison festgelegt. Eine danach unangetastete abgeschlossene Saison dient als Champion-/Challenger-Gate: verliert der neue Punkteforecast dort gegen v1, bleibt der v1-Forecast für diese Liga in Produktion. Preise und Spielplan werden jeweils wie an einem echten Saisonstart behandelt; Prognose- und reale Teampunktemetriken werden in das v2-Artefakt geschrieben. Danach wird das Produktionsmodell mit allen abgeschlossenen Saisons neu trainiert.
